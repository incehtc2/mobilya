  ...
  if (items.length === 0) {
    return (
      <div className="min-h-screen bg-cream pt-32 flex flex-col items-center justify-center gap-6 text-center px-6">
        ...
        <h1 className="font-display text-4xl font-light text-obsidian">
          Sepetiniz Boş
        </h1>
        <p className="font-body text-mist">
          Koleksiyonumuza göz atın ve beğendiğiniz ürünleri ekleyin.
        </p>
      ...
      <div className="mx-auto max-w-6xl px-6 lg:px-12">
        <div className="flex items-end justify-between mb-14">
          <div>
            ...
            <h1 className="font-display text-[clamp(2.5rem,4vw,4rem)] font-light text-obsidian">
              Sepetim
            </h1>
          </div>
        ...
        <div className="grid lg:grid-cols-[1fr_380px] gap-16 items-start">
            ...
            <div className="mt-12 grid grid-cols-3 gap-6 pt-8 border-t border-cream-dark">
              {TRUST.map(({ icon: Icon, label, sub }) => (
                ...
                >
                  ...
                  <p className="font-body text-xs font-medium text-obsidian">
                    {label}
                  </p>
          ...
          <div className="bg-cream-dark p-8 sticky top-32">
            <h2 className="font-display text-2xl font-light text-obsidian mb-8">
              Sipariş Özeti
            </h2>
            ...
            <div className="border-t border-cream-darker py-5 flex justify-between items-center">
              ...
              <span className="font-display text-3xl text-obsidian">
                {formatPrice(total)}
              </span>
            </div>
            ...
            <div className="mt-4 flex items-center justify-center gap-3">
              ...
              />
              <span className="font-body text-[10px] text-mist">
                ile güvenli ödeme
              </span>
            </div>
            ...
            <div className="mt-6 pt-6 border-t border-cream-darker">
              <Link
                href="/koleksiyonlar"
                className="block text-center font-body text-xs tracking-widest uppercase text-mist hover:text-obsidian transition-colors"
              >
                ← Alışverişe Devam Et
              </Link>
            </div>
